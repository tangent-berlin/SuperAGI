...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_index(
        "ix_agents_agnt_template_id", "agents", ["agent_template_id"], unique=False
    )
    op.create_index("ix_at_name", "agent_templates", ["name"], unique=False)
    op.create_index(
        "ix_ats_unique_id", "agent_template_steps", ["unique_id"], unique=False
    )
    op.create_index(
        "ix_aea_step_id", "agent_executions", ["current_step_id"], unique=False
    )
